...
varying vec2 vTexCoord0;
...
#if defined(USE_AA) || defined(USE_UP_SAMPLE) || defined(USE_DOWN_SAMPLE)
  uniform vec2 uTexelSize;

  #if defined(USE_FXAA_2) || defined(USE_FXAA_3) || defined(USE_UP_SAMPLE) || defined(USE_DOWN_SAMPLE)
  ...
  #endif
  #if defined(USE_FXAA_3) || defined(USE_UP_SAMPLE)
...
void main() {
  ...
  #if defined(USE_AA) || defined(USE_UP_SAMPLE) || defined(USE_DOWN_SAMPLE)
    #if defined(USE_FXAA_2) || defined(USE_FXAA_3) || defined(USE_UP_SAMPLE) || defined(USE_DOWN_SAMPLE)
      #if defined(USE_UP_SAMPLE) && defined(QUALITY) && QUALITY == 0
      float offset = 0.5;
      #else
      float offset = 1.0;
      #endif
